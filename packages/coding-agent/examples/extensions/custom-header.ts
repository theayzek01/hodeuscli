 ...
 * (logo + keybinding hints) with a custom component showing the Hodeuscli mascot.
 */

import type { ExtensionAPI, Theme } from "@games-coder/hodeuscli-coding-agent";
import { VERSION } from "@games-coder/hodeuscli-coding-agent";

// --- PI MASCOT ---
// Based on pi_mascot.ts - the Hodeuscli agent character
