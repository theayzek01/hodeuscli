...
import type { AssistantMessage, Model } from "@games-coder/hodeuscli-ai";
...
vi.mock("@games-coder/hodeuscli-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@games-coder/hodeuscli-ai")>();
	return {
		...actual,
