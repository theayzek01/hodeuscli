...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@games-coder/hodeuscli-tui";
...
const THEME_KEY = Symbol.for("@games-coder/hodeuscli-coding-agent:theme");
...
export function getSettingsListTheme(): import("@games-coder/hodeuscli-tui").SettingsListTheme {
	return {
