...
import { Container, Text, truncateToWidth } from "@games-coder/hodeuscli-tui";
...
function getTempFilePath(): string {
	...
	return join(tmpdir(), `hodeuscli-bash-${id}.log`);
}
...
/**
 * Create bash operations using Hodeuscli's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want Hodeuscli's
