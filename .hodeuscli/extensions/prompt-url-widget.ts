import { DynamicBorder, type ExtensionAPI, type ExtensionContext } from "@games-coder/hodeuscli-coding-agent";
import { Container, Text } from "@mariozechner/hodeuscli-tui";
